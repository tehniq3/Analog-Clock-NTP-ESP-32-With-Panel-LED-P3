...
char pass[] = "bererecelaburtica1"; // Password Wifi Anda
...
lineColor1 = matrix.ColorHSV(random(0, 1536), 255, 255, true);
lineColor2 = matrix.ColorHSV(random(0, 1536), 255, 255, true);
lineColor3 = matrix.ColorHSV(random(0, 1536), 255, 255, true);
lineColor4 = matrix.ColorHSV(random(0, 1536), 255, 255, true);
}
...
if (tm->tm_sec == 0)
{           
//lineColor1 = matrix.ColorHSV((tm->tm_sec + tm->tm_min) * 30, 255, 255, true);
lineColor1 = matrix.ColorHSV(random(0, 1536), 255, 255, true);
lineColor2 = matrix.ColorHSV(random(0, 1536), 255, 255, true);
lineColor3 = matrix.ColorHSV(random(0, 1536), 255, 255, true);
lineColor4 = matrix.ColorHSV(random(0, 1536), 255, 255, true);
